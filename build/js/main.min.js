...
/*!*************************!*\
  !*** ./js/accordion.js ***!
  \*************************/
/*! exports provided: activateAccordion */
...
var hideContent = function hideContent(indexOpenContent) {
  accordionContents.forEach(function (item, index) {
    var header = item.querySelector('.accordion__header');
    var content = item.querySelector('.accordion__group-list');
...
var resetHeight = function resetHeight(content, header) {
...
/* harmony import */ var _show_more_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./show-more.js */ "./js/show-more.js");
/* harmony import */ var _phone_mask_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./phone-mask.js */ "./js/phone-mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_accordion_js__WEBPACK_IMPORTED_MODULE_3__["activateAccordion"])();
    Object(_show_more_js__WEBPACK_IMPORTED_MODULE_4__["activateShowMore"])();
    Object(_phone_mask_js__WEBPACK_IMPORTED_MODULE_5__["activateTelMask"])();
  });
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "activateTelMask", function() { return activateTelMask; });
/* harmony import */ var _modules_form_validate_init_phone_input_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/form-validate/init-phone-input.js */ "./js/modules/form-validate/init-phone-input.js");

var activateTelMask = function activateTelMask() {
  var inputTelParent = document.querySelector('.form__input-tel');
  Object(_modules_form_validate_init_phone_input_js__WEBPACK_IMPORTED_MODULE_0__["initPhoneInput"])(inputTelParent);
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "activateShowMore", function() { return activateShowMore; });
var showMoreContent = document.querySelector('.about');
var showMoreButton = showMoreContent.querySelector('.about__button');
var hiddenText = showMoreContent.querySelector('.about__additional-text');
var activateShowMore = function activateShowMore() {
  showMoreButton.addEventListener('click', function () {
    ...
    if (showMoreButton.classList.contains('is-open')) {
      ...
      hiddenText.style.height = "".concat(hiddenText.scrollHeight, "px");
    } else {
  ...
  _createClass(ScrollLock, [{
    ...
    value: function disableScrolling() {
      ...
      if (this._getScrollbarWidth()) {
        ...
        document.querySelector('.main-header').style.width = "calc(100% - ".concat(this._getScrollbarWidth(), "px)");
